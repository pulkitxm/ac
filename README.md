...
==> starting novasynth-postgres
  waiting for novasynth-postgres .. ready
  ok novasynth-postgres up  192.168.64.2/24
...
```
...
Shutdown refcounts across **all** projects: stopping `novasynth` while another
