...
pub enum Action {
    ...
    ///
    /// Examples:
    ///   ac noveum run postgres psql -U user -h noveum-postgres
    ///   ac noveum run redis sh
    ...
    /// Examples:
    ///   ac noveum wait
    ///   ac noveum wait postgres --timeout 30 && psql ...
    Wait {
    ...
    ///
    /// Examples:
    ///   ac noveum push --profile pre-prod
    ///   ac noveum push web -P dev
    Push {
